...
function Lytebox(bInitialize, aHttp) {
	/*** Language Configuration ***/
		...
		this.label['prev'] 		= 'Precédent';	// Previous (left arrow)
	...
	/*** Configure Lytebox ***/
		...
		this.maxOpacity			= 90;			// higher opacity = darker overlay, lower opacity = lighter overlay
...
Lytebox.prototype.changeContent = function(iContentNum) {
	...
	if (this.isLyteframe) {
		...
		this.imgPreloader.onload = function() {
			...
			if ($lb.autoResize) {
				var x = $lb.aPageSize[2] - 10;
				var y = $lb.aPageSize[3] - 60;
				if (imageWidth > x) {
